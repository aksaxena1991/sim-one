        ...
        thisRef.startMove = function (e) {
          ...
          thisRef.resetUI = function () {
            ...
            waves.each(function(i,v){
                ...
                left = left + (30/2.2);
                if((id%2 === 0) && (id !== 20) && (id !== 48) && (id !== 36) && (id !== 30) ) {
                    angular.element(v).addClass('plane_wave').removeClass('white_particle_wave');
                    angular.element('#'+strID).css('left',left+'px');
                    angular.element('#'+strID)[0].style.animationDuration = '';
                    angular.element('#'+strID)[0].style.animationDirection = '';
                    angular.element('#'+strID)[0].style.animationTimingFunction = '';
                    angular.element('#'+strID)[0].style.animationIterationCount = '';
                    angular.element('#'+strID)[0].style.animationFillMode = '';
                    angular.element('#'+strID)[0].style.animationPlayState = '';
                    angular.element('#'+strID)[0].style.animationName = '';
                    // angular.element('#'+strID)[0].style.animation = '';


                    console.log(angular.element('#'+strID),'saxena')
                }
            });
