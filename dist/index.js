...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "8426128b78d955844343";
...
var Event = /** @class */ (function () {
    function Event(startID, resetID) {
        this.startID = '';
        this.resetID = '';
        this.startID = startID;
        this.resetID = resetID;
    }
    Event.prototype.addStartEvent = function () {
        var _this = this;
        var btn = jquery_1.default('#' + this.startID);
        btn.click(function () {
            _this.animateBar();
        });
    };
    Event.prototype.addResetEvent = function () { };
...
Object.defineProperty(exports, "__esModule", { value: true });
var CreateCanvas = /** @class */ (function () {
    ...
    CreateCanvas.prototype.init = function () {
        var _a, _b;
        this.canvas.id = this.id;
        (_a = this.canvas) === null || _a === void 0 ? void 0 : _a.setAttribute('height', "" + this.height);
        (_b = this.canvas) === null || _b === void 0 ? void 0 : _b.setAttribute('width', "" + this.width);
        this.body.appendChild(this.canvas);
    };
    CreateCanvas.prototype.getCanvas = function () {
        return this.canvas;
    };
    CreateCanvas.prototype.getContext = function () {
        var cnvs = this.getCanvas();
